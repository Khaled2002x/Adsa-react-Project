...
export default function Blog() {
  ...
  const urlCategory = prams[0].get("category");
    ...
    <>
      <div className="main p-5 ">
        <div className="hero m-auto mt-5 p-3 ">
          ...
          <div className="select_category d-flex flex-lg-row w-100   gap-4 flex-column    align-items-center ">
            <div className=" w-100">
              <input
                onChange={(e) => smartSearch(e.target.value)}
                type="text"
                placeholder="بحث في مقالات "
                className=" px-3 w-75 py-2 rounded-3 search_input text-white"
              />
            </div>

            <div className="select_category_button  w-100 row  g-3 ">
              <div className="col-4 col-lg-4">
                <div className={`category_btn rounded-4 text-white border-0`}>
                  <button
                    onClick={() => {
                      Setcategory("all");
                    }}
                    className={`categoryBtn  ${category === "all" ? "active" : ""}  text-white `}
                  >
                    جميع المقالات{" "}
                  </button>
                </div>
              ...
              <div className="col-4 col-lg-4">
                <div className={`category_btn   rounded-4 text-white border-0`}>
                  <button
                    ...
                    className={`categoryBtn ${category === "إضاءة" ? "active" : ""}  text-white`}
                  >
                    إضاءة{" "}
                  </button>
                </div>
              ...
              <div className="col-4 col-lg-4">
                <div className={`category_btn   rounded-4 text-white border-0`}>
                  <button
                    ...
                    className={`categoryBtn ${category === "بورتريه" ? "active" : ""}   text-white`}
                  >
                    بورتريه
                  </button>
                </div>
              ...
              <div className="col-4 col-lg-4">
                <div
                  className={`category_btn text-center  rounded-4 text-white border-0`}
                >
                  <button
                    onClick={() => {
                      Setcategory("تقنيات");
                    }}
                    className={`categoryBtn  text-white ${category === "تقنيات" ? "active" : ""} `}
                  >
                    تقنيات
                  </button>
                </div>
              ...
              <div className="col-4 col-lg-4">
                <div className={`category_btn  rounded-4 text-white border-0`}>
                  <button
                    ...
                    className={`categoryBtn ${category === "معدات" ? "active" : ""} text-white`}
                  >
                    معدات
                  </button>
                </div>
